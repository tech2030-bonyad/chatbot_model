...
KNOWLEDGE_BASE_FILE = Path(__file__).parent / "how-To-Use"
...
def fetch_documents():
    """Load the BONYAD how-to-use documentation"""
    ...
    if KNOWLEDGE_BASE_FILE.exists():
        with open(KNOWLEDGE_BASE_FILE, "r", encoding="utf-8") as f:
            documents.append({
                "type": "user-guide",
                "source": KNOWLEDGE_BASE_FILE.name,
                "text": f.read()
            })
    else:
        print(f"Warning: {KNOWLEDGE_BASE_FILE} not found!")
